      ...
      <div style={{ margin: "0 8px 14px", padding: "10px", borderRadius: 10, background: "rgba(139,0,0,.07)", border: "1px solid rgba(139,0,0,.14)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
          ...
          <div style={{ minWidth: 0 }}>
            <div style={{ fontSize: 11, fontWeight: 600, color: "#f5d0d0", fontFamily: "'Rajdhani',sans-serif", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>Alex Johnson</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        ...
        <Card delay={.05} style={{ padding: 20 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 18 }}>
            ...
            <div>
              <div style={{ fontSize: 16, fontWeight: 700, color: "#f5d0d0", fontFamily: "'Rajdhani',sans-serif" }}>Alex Johnson</div>
              <div style={{ fontSize: 9, color: "rgba(239,68,68,.5)", fontFamily: "'JetBrains Mono',monospace", marginTop: 2 }}>alex.johnson@email.com</div>
          ...
          {[["Full Name", "Alex Johnson"], ["Email", "alex.johnson@email.com"], ["Phone", "+1 (555) 123-4567"], ["Member Since", "January 2024"]].map(([k, v]) => (
